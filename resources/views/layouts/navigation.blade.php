<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif (Auth::user()->role === \App\Models\User::ROLE_GURU)
                        {{-- removed manage attendance menu for guru --}}
                    @endif

                    @if (Auth::user()->role === \App\Models\User::ROLE_SISWA)
                        <x-nav-link :href="route('attendance.me')" :active="request()->routeIs('attendance.me')">
                            Riwayat Absensi
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->role === \App\Models\User::ROLE_SISWA)
                <x-responsive-nav-link :href="route('attendance.me')" :active="request()->routeIs('attendance.me')">
                    Riwayat Absensi
                </x-responsive-nav-link>
            @endif
        </div>
